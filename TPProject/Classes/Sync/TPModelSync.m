...
- (void) doSync:(int)syncType {
    ...
    switch (syncType) {
        ...
        case SYNC_TYPE_DATA:
            ...
            upload_xml = [database getUserDataListXMLEncoding]; // Encode list of user data objects
            requestStr = [NSString stringWithFormat:@"%@&firstsyncafterupgrade=%d&userdatalist=%@",
                          basicValues, isFirstSyncAfterUpgrade, upload_xml];
            break;
        case SYNC_TYPE_IMAGEDATA:
