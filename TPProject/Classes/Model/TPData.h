...
- (id) initWithModel:(TPModel *)aModel userdataID:(NSString *)aUserdataID name:(NSString *)aName share:(int)aShare description:(NSString *)description creationDate:(NSDate *)aDate;
